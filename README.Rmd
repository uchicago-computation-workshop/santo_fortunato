...
title <- "Science of Science: Universality, Reputation, Attention, Inflation and Novelty"
file_title <- "Science of Science"
short_title_n = 3
speaker <- "Santo Fortunato"
department <- "Professor in the School of Informatics and Computing, Director of the Center for Complex Networks and Systems Research"
